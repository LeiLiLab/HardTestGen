...
📎 [Huggingface - Problems](https://huggingface.co/datasets/sigcp/hardtests_problems) This dataset contains the problem descriptions and oracle programs of each problem.

📎 [Huggingface - Test Cases](https://huggingface.co/datasets/sigcp/hardtests_tests) This dataset contains the test cases generated by our HARDTESTGEN pipeline for each problem.
